...
def load_images():
	...
	for i in images:
		exec "global {0}; {0}=games.load_image(resource_path('res/{1}.png'), transparent={2})".format(i, images[i][0], images[i][1])
...
class Ship(Wrapper):
	...
	def __init__(self, num):
		games.Sprite.__init__(self, games.load_image(resource_path('res/ship'+str(num)+'.png')),
